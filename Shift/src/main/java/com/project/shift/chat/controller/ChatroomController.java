...
public class ChatroomController {
	...
	public ResponseEntity<List<ChatroomListDTO>> getUserChatroomList() {
        return ResponseEntity.ok(chatroomService.getUserChatrooms(getUserIdOrNull()));
    }
	...
	public ResponseEntity<Long> addChatroom(@RequestBody MessageWithSenderDTO payload) {		
	    ...
	    return ResponseEntity.status(HttpStatus.CREATED).body(newChatroomId);
	}
	...
	public ResponseEntity<MessageResponseDTO> deleteUsersChatroom(@PathVariable long chatroomUserId) {
	...
	public ResponseEntity<List<ChatroomListDTO>> searchChatroomUsersName(@RequestParam String input) {
        return ResponseEntity.ok(chatroomService.searchChatroomUsersName(input, getUserIdOrNull()));
    }
	...
	public ResponseEntity<List<MessageSearchResultDTO>> searchChatroomMessages(@RequestParam String input) {
        return ResponseEntity.ok(chatroomService.searchChatroomMessages(input, getUserIdOrNull()));
    }
}
